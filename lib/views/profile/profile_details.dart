...
class _ProfileDetailsState extends State<ProfileDetails> {
  ...
  Widget build(BuildContext context) {
    final userProvider = Provider.of<ProfileProvider>(context);
        final getuser = userProvider.getUserProfile(context: context);
          ...
          horizontal: 20.w),
            ...
            CrossAxisAlignment.center,
                ...
                Name(heading: "Name",
                      ...
                      cont: name,
                      initValue: userProvider.userModel?.first_name!),
                SizedBox(height: 10.h,),
                  Email(heading: "Email",
                      image: 'Assets/icons/email.png',
                      cont: email,
                      initValue: userProvider.userModel?.email!),
                  SizedBox(height: 10.h,),
                  MobileNumber(
                      heading:"Mobile Number",
                      image: 'Assets/icons/mobilenumber.png',
                      cont:mobnum,
                      initValue:userProvider.userModel?.phone_number!
                  ),
                  SizedBox(height: 10.h,),
                  //CHANGE PASSWORD
                  GestureDetector(
                      onTap: (){
                        showDialog(
                          context: context,
                          builder: (BuildContext context) => ChangePassword(context),
                        );
                            ...
                            child: SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(padding: REdgeInsets.fromLTRB(0, 5, 0, 0),
                                        child: Roboto_subheading(textValue: "Password", size: 15.sp))
                                        ],
                                      ),
                                    ),
                                    SizedBox(height:15.h),
                                Padding(padding: REdgeInsets.fromLTRB(10, 0, 0, 0),
                                    child:  Text("*******",
                                      style:  TextStyle(
                                    ...
                                    SizedBox(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Padding(padding: REdgeInsets.fromLTRB(0, 5, 0, 0),
                                              child: Roboto_subheading(textValue: "Card Details", size: 15.sp))
                                        ],
                                      ),
                                    ),
                                    SizedBox(height:13.h),
                                Padding(padding: REdgeInsets.fromLTRB(10, 0, 0, 0),
                                    child: Text("xxxx-xxxx-xxxx-3452",
                                      style:  TextStyle(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: Row(
                      children: [
                        ...
                        Padding(padding: REdgeInsets.fromLTRB(0, 5, 0, 0),
                        child: Roboto_subheading(textValue: heading, size: 15.sp))
                  ...
                  TextFormField(
                    ...
                    style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.normal, fontFamily: "Roboto"),
                    validator: (value) {
    ...
    return AlertDialog(
      ...
      content:  Column(
        ...
        children: <Widget>[
          ...
          Padding( padding: EdgeInsets.fromLTRB(1, 15, 1, 10),
            child:  NavButton(
              buttonText: 'Save Changes',
              textSize: 20.sp,
              buttonHeight: 50.h,
